...
SkillDirect dryer= {"Hair dryer 3000", "It’s shaped like a hairdryer but when you try to use it, a tornado comes out of it and attacks the enemy.You can only use it one time during the battle.", 25,0,0}; 
...
//defense skills
SkillDirect backpack = {"Jetback Backpack", "When somebody attacks you, you have the ability to fly away from them without getting damaged. It's going to add you 10 defense points\n", 0, 10, 0};
SkillDirect umbrella = {"All-Weather Umbrella", "When you open the umbrella it creates a protective shield against the attacks of your enemies to protect you. It's going to add you 15 defense points.\n", 0, 15, 0};
SkillDirect perfume = {"Ice-Queen perfume", "When you apply the perfume to yourself it creates an ice-shield to defend yourself from the attacks of your enemy. It's going to add you 10 defense points.\n", 0, 10, 0};
